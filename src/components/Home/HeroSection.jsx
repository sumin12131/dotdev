...
const HeroSection = () => {
  return (
    <div className="hero-wrapper flex flex-col items-center mt-6">
      ...
      <p className="mt-10 text-lg text-center leading-7 dark:text-neutral-400 max-w-4xl">
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Ab
        blanditiiseius odio id iusto odit quasi consequuntur, quaerat non at
        rerum obcaecati. Aliquid perferendis nam dignissimos libero aut!
        Adipisci, neque!
      </p>
      <div className="sub-links mt-10 flex gap-3">
        {heroLinks.map((link, index) => (
          <Link
            key={index}
            to={link.to}
            className="py-[0.75rem] px-[1.5rem] border dark:text-neutral-400"
          >
            {link.text}
          </Link>
        ))}
